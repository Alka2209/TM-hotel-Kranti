			...
			<div class="bg-holder full">
				...
				<div class="bg-holder-content full text-white one-point-one">
					<a class="logo-holder" href="index.php">
						<img src="<?php echo $client_domain; ?>/img/logo.png" alt="<?php echo $hotel_name; ?>" title="<?php echo $hotel_name; ?>" />
					</a>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 col-md-offset-3">
									...
									<a class="btn btn-white btn-ghost btn-lg mt5" href="/"><i class="fa fa-long-arrow-left"></i> To Homepage</a>
