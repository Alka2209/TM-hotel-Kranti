	...
	<div class="container">
		...
		<div class="booking-item-details">
			<header class="booking-item-header">
				<div class="row">
					<div class="col-md-9">
						<h1 style="margin-top: 40px;" class="h2 lh1em text-color">Hotel TM, Madurai - Deluxe Rooms</h1>
					</div>
				</div>
			</header>
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="tab-1">
								<div class="fotorama" data-allowfullscreen="true" data-nav="thumbs" data-loop="true">
									<img src="img/gallery/deluxe-room-1.jpg" alt=""/>
									<img src="img/gallery/deluxe-room-2.jpg" alt=""/>
									<img src="img/gallery/deluxe-room-3.jpg" alt=""/>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="thumb">
							...
							<div class="thumb-caption">
								...
								<pclass="thumb-desc">Well appointed and elegantly decorated and equipped with all the amenities for comfortable stay.</p>
							</div>
							<div class="gap gap-small"></div>
							<a class="btn btn-primary" href="executive-room.php">View More</a>
						</div>
					</div>
